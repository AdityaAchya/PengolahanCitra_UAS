...
if __name__ == "__main__":
    input_path = "C:/Users/Aditya Achya/Documents/UAS/PengolahanCitra_UAS-main/PengolahanCitra_UAS-main/UASCITRA/image.jpg"  # Ganti dengan path gambar input Anda
    output_directory = "C:/Users/Aditya Achya/Documents/UAS/PengolahanCitra_UAS-main/PengolahanCitra_UAS-main/UASCITRA/Output/"  # Ganti dengan direktori untuk menyimpan gambar hasil
    
    if not os.path.exists(output_directory):
        os.makedirs(output_directory)
    
    output_path = os.path.join(output_directory, "output_image3.jpeg")  # Nama file output
